...
//twolio 2nd iteration

const twilio = require("twilio");
const client = twilio("AC90676a7fda31dedf051da1d64211905b", "272d080ce9ada9fdeae8a7ef04c31af2");
...
module.exports.postLogin = async (req, res) => {
    ...
    try {
        ...
        // const phoneNumber = '7907396181';

        // Verify the OTP with Twilio
        client.verify
            .services("VA07005722120c44f4fd1a4760d4e0a35f")
            .verificationChecks
            .create({ to: phoneNumber, code: otp }) // Use the constructed phone number
            .then((verificationCheck) => {
                if (verificationCheck.status === "approved") {
                    ...
                    // Invalid OTP, render the login page with an error message
                    return res.render("userLogin", { error: "Invalid OTP" });
                }
            })
            .catch((error) => {
